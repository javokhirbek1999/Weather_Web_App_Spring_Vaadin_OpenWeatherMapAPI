...
/*
*  try {
            JSONArray jsonArray = weatherService.returnWeatherArray("San Francisco");
            JSONObject myObject = weatherService.returnMainObject("San Francisco");
            JSONObject windObject = weatherService.returnWind("San Francisco");
            JSONObject sunSet = weatherService.returnSunSet("San Francisco");

            System.out.println("Temperature: " + myObject.getDouble("temp"));
            System.out.println("\nWind Speed: " + windObject.getDouble("speed") + "\nWind Degree: " + windObject.getInt("deg"));
            System.out.println("Sun Set: " + sunSet.getInt("sunset"));
